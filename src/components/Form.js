    ...
    return (
        <>
                <div>
                    ...
                    <button className='btn-Remova effect04' onClick={remove}>
                        Remova all
                    </button>
                </div>
            ...
            <button className='btn-Active effect04' onClick={() => changeTypeHandler('Active')}>
                Active
            </button>
            <button className='btn-Completed effect04' onClick={() => changeTypeHandler('Completed')}>
                Completed
            </button>
        </>
    )
